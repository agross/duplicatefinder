...
namespace DuplicateFinder.Core.IntegrationSpecs
{
  ...
  public class When_files_outside_the_scanned_directories_are_moved_to_the_archive : HistorySpecs
  {
    ...
    Establish context = () =>
    {
      ...
      var run1 = parser.Parse((@"--content --history " + History +
                               @" --keep HashCodeHistory_FileWasMoved\Run1_FileExists\Archive" +
                               @" HashCodeHistory_FileWasMoved\Run1_FileExists\Archive" +
                               @" HashCodeHistory_FileWasMoved\Run1_FileExists\Scanned").Args());
      run1.Execute();

      Run2 = parser.Parse((@"--content --history " + History +
                           @" --keep HashCodeHistory_FileWasMoved\Run2_FileWasMoved\Archive" +
                           @" HashCodeHistory_FileWasMoved\Run2_FileWasMoved\Archive" +
                           @" HashCodeHistory_FileWasMoved\Run2_FileWasMoved\Scanned").Args());
    };
