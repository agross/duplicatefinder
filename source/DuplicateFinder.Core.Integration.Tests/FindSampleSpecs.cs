...
namespace DuplicateFinder.Core.Integration.Tests
{
  ...
  public class When_duplicates_are_searched_by_size
  {
    ...
    Establish context =
      ...
      {
        Command =
          new CommandLineParser().Parse(
                                        CommandLine.EnumerableExtensions.Args(
                                                                              (string)
                                                                              @"--size --whatif Samples\First Samples\Second"));
      };
      ...
      () =>
      {
        Command =
          new CommandLineParser().Parse(
                                        CommandLine.EnumerableExtensions.Args(
                                                                              (string)
                                                                              @"--name --whatif Samples\First Samples\Second"));
      };
      ...
      () =>
      {
        Command =
          new CommandLineParser().Parse(
                                        CommandLine.EnumerableExtensions.Args(
                                                                              (string)
                                                                              @"--content --whatif Samples\First Samples\Second"));
      };
      ...
      () =>
      {
        Command =
          new CommandLineParser().Parse(
                                        CommandLine.EnumerableExtensions.Args(
                                                                              (string)
                                                                              @"--content --first 5 --whatif Samples\First Samples\Second"));
      };
      ...
      () =>
      {
        Command =
          new CommandLineParser().Parse(
                                        CommandLine.EnumerableExtensions.Args(
                                                                              (string)
                                                                              @"--content --last 5 --whatif Samples\First Samples\Second"));
      };
      ...
      () =>
      {
        Command =
          new CommandLineParser().Parse(
                                        CommandLine.EnumerableExtensions.Args(
                                                                              (string)
                                                                              @"--content --first 5 --last 5 --whatif Samples\First Samples\Second"));
      };
